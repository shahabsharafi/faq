...
import { SigninComponent, SignupComponent, WelcomeComponent, AccountListComponent, RoleListComponent, DiscountListComponent, DepartmentTreeComponent } from './components/index';
